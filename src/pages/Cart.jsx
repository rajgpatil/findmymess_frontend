...
const Cart = () => {
    ...
    useEffect(()=>{
        ...
        // tempData = [{
        //     0: {_id: 'aaaab', size: 'M', quantity: 3},
        //     1: {_id: 'aaaaa', size: 'S', quantity: 1},
        //     2: {_id: 'aaaaa', size: 'M', quantity: 1}
        // }]
        }
            ...
            <div>
                {
                    cartData.map((item,index)=>{
                        ...
                        return (
                            <div key={index} className='py-4 border-t border-b text-grey-700 grid grid-cols-[4fr_0.5fr_0.55fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
                                <div className='flex items-start gap-4'>
                                    ...
                                    <div>
                                        ...
                                        <div className='flex items-center gap-5 mt-2'>
                                            <p>{currency}{item.size === "Full" ? productData.fullprice : productData.halfprice}</p>
